...
const Header = () => {
    ...
    useEffect(()=>{
        ...
        const timer = setTimeout( () => getSearchSuggestion(), 10)
        return () =>{
            clearTimeout(timer)
        }
    },[searchValue])
            ...
            <div className="container-fluid mx-auto px-5 flex items-center">
                <div className="w-1/5 flex">
                    <button 
                        ...
                        className="mr-6 cursor-pointer"><i className="fa fa-bars fa-lg" aria-hidden="true"></i></button>
                    <a href="#" className="text-red-light tracking-tight">
                        <svg width="130px" id="yt-logo-updated_yt1" viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                            <g>
                ...
                <div className="w-3/5">
                    <div className="relative">
                        ...
                        <div className=' bg-white fixed w-100  py-2 px-5'>
                            <ul>
                                {suggestions.map((suggestion)=>(<li className='py-2 border-b' key={suggestion}>{suggestion.snippet.title}</li>))}
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="w-1/5">
                    <div className="flex items-center justify-end">
                        <a href="#" className="mr-6"><i className="fa fa-upload fa-lg" aria-hidden="true"></i></a>
                        <a href="#" className="mr-6"><i className="fa fa-th fa-lg" aria-hidden="true"></i></a>
                        <a href="#" className="mr-6"><i className="fa fa-bell fa-lg" aria-hidden="true"></i></a>
                        <a href="#">
                            <img className="h-8 w-8 rounded-full" src="https://yt3.ggpht.com/-d4QhdOi4N6c/AAAAAAAAAAI/AAAAAAAAAAA/vpG4T-iVv7w/s88-c-k-no-mo-rj-c0xffffff/photo.jpg" alt="avatar"/>
                        </a>
                    </div>
                </div>
            </div>
